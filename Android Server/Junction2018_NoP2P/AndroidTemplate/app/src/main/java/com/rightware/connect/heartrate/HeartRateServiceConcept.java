...
import com.rightware.connect.ExternalServiceBase;
import com.rightware.connect.ExternalServiceSession;
import com.rightware.connect.MessagePackage;
import com.rightware.connect.MessageUtil;

public class HeartRateServiceConcept extends ExternalServiceBase {
    static final String TAG = "WeatherServiceConcept";

    public HeartRateServiceConcept() {
